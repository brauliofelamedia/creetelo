        ...
        <div class="container-fluid">
            <div class="mapouter">
                <div class="gmap_canvas">
                    <iframe width="1920" height="550" id="gmap_canvas" src="https://maps.google.com/maps?q=badsha%20mia%20school&t=&z=17&ie=UTF8&iwloc=&output=embed">	
                    </iframe>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row pt-60 g-5">
                ...
                <div class="col-lg-4">
                    ...
                    <input class="form-control" type="tel" id="phone" name="phone" placeholder="0196-153-89-15" pattern="[0-9]{4}-[0-9]{3}-[0-9]{2}-[0-9]{2}" required>
                </div>
            </div>
            <div class="row pt-40 g-5">
                <div class="col-lg-6">
                    <label class="form-label mb-10">Country</label>
                ...
                <div class="col-lg-6">
                    <label class="form-label mb-10">Birthdate</label>
            ...
            <div class="row pt-40 g-5">
                <div class="col">
                    ...
                    <textarea class="form-control" placeholder="Write Your Messages" id="exampleFormControlTextarea1" rows="10"></textarea>
