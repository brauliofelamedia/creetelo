...
@section('content')
    ...
    <div class="about-us-banner" style="background-image: url('{{asset('images/banner.png')}}')" style="background-position: 0 -90px!important;padding: 60px 0!important;">
                    ...
                    <div class="col-lg-4">
                        <div class="mb-20 candidates-details-left d-flex flex-column justify-content-center pt-60">
                            ...
                            <div class="Profile-name pt-30 d-flex flex-column">
                                ...
                                <span style="display: none;">{{$user->ocupation}}</span>
                            </div>
                                    ...
                                    <div class="candidates-1 d-flex flex-column align-items-center justify-content-center">
                                        ...
                                        <div class="Candidates-grid">
                                            ...
                                            <div class="pt-20 top-grid-4 d-flex flex-column align-items-center justify-content-center">
                                                <a href="{{route('front.contact.detail',$user['contact_id'])}}"><span>Conoce esta Creída</span></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
